...
public void enterpaymentNoBasedonType(int i,String paymentNumberValue) {
	...
	WebElement Payment_PaymentType=driver.findElement(By.xpath("//select[contains(@id,'PayType') and contains(@id,'"+i+"')]"));
	if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("Check")) {
		ElementUtil.webEditTxt(Payment_PaymentNumbertxt, paymentNumberValue);
	}
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("Certified Check")){
		ElementUtil.webEditTxt(Payment_PaymentNumbertxt, paymentNumberValue);
	}
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("Wire Transfer")){
		ElementUtil.webEditTxt(Payment_PaymentNumbertxt, paymentNumberValue);
	}
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("EFT")){
		ElementUtil.webEditTxt(Payment_PaymentNumbertxt, paymentNumberValue);
	}
...
public void enterPaymentAmountBasedonType(int i,String paymentAmountValue) {
	...
	WebElement Payment_PaymentType=driver.findElement(By.xpath("//select[contains(@id,'PayType') and contains(@id,'"+i+"')]"));
	if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("Cash")) {
		ElementUtil.webEditTxt(Payment_PaymentAmount, paymentAmountValue);
	}
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("Check")){
		ElementUtil.webEditTxt(Payment_PaymentAmount, paymentAmountValue);
	}
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("Certified Check")){
		ElementUtil.webEditTxt(Payment_PaymentAmount, paymentAmountValue);
	...
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("Enterprise System Credit")){
		ElementUtil.webEditTxt(Payment_PaymentAmount, paymentAmountValue);
	}
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("IRP System Credit")){
		ElementUtil.webEditTxt(Payment_PaymentAmount, paymentAmountValue);
	}
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("IFTA System Credit")){
		ElementUtil.webEditTxt(Payment_PaymentAmount, paymentAmountValue);
	}
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("OPA System Credit")){
		ElementUtil.webEditTxt(Payment_PaymentAmount, paymentAmountValue);
	}
	else if(ElementUtil.FetchDropdownSelectedValue(Payment_PaymentType).trim().equalsIgnoreCase("IFTA Bond")){
		ElementUtil.webEditTxt(Payment_PaymentAmount, paymentAmountValue);
	}
}
