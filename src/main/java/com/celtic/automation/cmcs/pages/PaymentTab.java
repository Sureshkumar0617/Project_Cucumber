...
public String FetchBatchCredential() {
	...
	if(ElementUtil.FetchTextBoxValuewithattribute(paymentBatchCredentialChk,"checked")==null){
		boolstatus=false;
	}
	else {
		boolstatus=true;
...
public String FetchWireTransferFee() {
	boolean boolstatus=false;
	if(ElementUtil.FetchTextBoxValuewithattribute(paymentWireTransferFeeChk,"checked")==null){
		boolstatus=false;
	}
	else {
		boolstatus=true;
